...
RSpec.describe WorkflowsController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all workflows as @workflows" do
      workflow = Workflow.create! valid_attributes
      get :index, params: {}, session: valid_session
      expect(assigns(:workflows)).to eq([workflow])
    end
  end

  describe "GET #show" do
    it "assigns the requested workflow as @workflow" do
      workflow = Workflow.create! valid_attributes
  ...
  describe "GET #new" do
    it "assigns a new workflow as @workflow" do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created workflow as @workflow" do
        post :create, params: {workflow: valid_attributes}, session: valid_session
        expect(assigns(:workflow)).to be_a(Workflow)
        expect(assigns(:workflow)).to be_persisted
      end
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved workflow as @workflow" do
  ...
  describe "PUT #update" do
    ...
    context "with invalid params" do
      it "assigns the workflow as @workflow" do
        workflow = Workflow.create! valid_attributes
