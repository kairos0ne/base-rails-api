...
RSpec.describe EpicsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested epic as @epic" do
      epic = Epic.create! valid_attributes
      get :show, params: {id: epic.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested epic as @epic" do
      epic = Epic.create! valid_attributes
      get :edit, params: {id: epic.to_param}, session: valid_session
      expect(assigns(:epic)).to eq(epic)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Epic" do
        expect {
          post :create, params: {epic: valid_attributes}, session: valid_session
        }.to change(Epic, :count).by(1)
      end

      it "assigns a newly created epic as @epic" do
        post :create, params: {epic: valid_attributes}, session: valid_session
        expect(assigns(:epic)).to be_a(Epic)
        expect(assigns(:epic)).to be_persisted
      end

      it "redirects to the created epic" do
        post :create, params: {epic: valid_attributes}, session: valid_session
        expect(response).to redirect_to(Epic.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved epic as @epic" do
        post :create, params: {epic: invalid_attributes}, session: valid_session
        expect(assigns(:epic)).to be_a_new(Epic)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested epic" do
        epic = Epic.create! valid_attributes
        put :update, params: {id: epic.to_param, epic: new_attributes}, session: valid_session
        epic.reload
      ...
      it "assigns the requested epic as @epic" do
        epic = Epic.create! valid_attributes
        put :update, params: {id: epic.to_param, epic: valid_attributes}, session: valid_session
        expect(assigns(:epic)).to eq(epic)
      end
      ...
      it "redirects to the epic" do
        epic = Epic.create! valid_attributes
        put :update, params: {id: epic.to_param, epic: valid_attributes}, session: valid_session
        expect(response).to redirect_to(epic)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the epic as @epic" do
        epic = Epic.create! valid_attributes
        put :update, params: {id: epic.to_param, epic: invalid_attributes}, session: valid_session
        expect(assigns(:epic)).to eq(epic)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested epic" do
      epic = Epic.create! valid_attributes
      expect {
        delete :destroy, params: {id: epic.to_param}, session: valid_session
      }.to change(Epic, :count).by(-1)
    end
    ...
    it "redirects to the epics list" do
      epic = Epic.create! valid_attributes
      delete :destroy, params: {id: epic.to_param}, session: valid_session
      expect(response).to redirect_to(epics_url)
    end
  end
