...
class TypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create type" do
    assert_difference('Type.count') do
      post types_url, params: { type: { references: @type.references, type: @type.type } }, as: :json
    end
  ...
  test "should update type" do
    patch type_url(@type), params: { type: { references: @type.references, type: @type.type } }, as: :json
    assert_response 200
  end
